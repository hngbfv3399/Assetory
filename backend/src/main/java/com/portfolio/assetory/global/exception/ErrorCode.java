...
public enum ErrorCode {
	...
	PRODUCT_COLLABORATOR_NOT_FOUND(HttpStatus.NOT_FOUND, "공동 작업자를 찾을 수 없습니다."),
	PRODUCT_COLLABORATOR_ALREADY_EXISTS(HttpStatus.CONFLICT, "이미 초대되었거나 공동 작업자로 등록된 회원입니다."),
	INVALID_COLLABORATOR_STATUS(HttpStatus.BAD_REQUEST, "현재 공동 작업자 상태에서는 요청을 처리할 수 없습니다."),
	PRODUCT_CHANGE_REQUEST_NOT_FOUND(HttpStatus.NOT_FOUND, "상품 변경 요청을 찾을 수 없습니다."),
	INVALID_PRODUCT_CHANGE_REQUEST_STATUS(HttpStatus.BAD_REQUEST, "현재 상품 변경 요청 상태에서는 처리할 수 없습니다."),
